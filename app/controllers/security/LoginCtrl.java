...
public class LoginCtrl extends Controller {
    ...
    public Result login() {
	   ...
	   return ok(login.render(formFactory.form(Login.class),(Customer) User.getLoggedIn(session().get("email"))));
    }
    ...
    public Result loginSubmit() {
        ...
        if (loginForm.hasErrors()) {
            ...
            return badRequest(login.render(loginForm,(Customer) User.getLoggedIn(session().get("email"))));
        } 
        else {
